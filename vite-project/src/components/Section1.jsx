...
const HOUSES = [
  {
    ...
    sigil_url: publicAsset('images/one.jpg'),
  ...
  },
  {
    ...
    sigil_url: publicAsset('images/two.jpg'),
  ...
  },
  {
    ...
    sigil_url: publicAsset('images/three.png'),
  ...
  },
  {
    ...
    sigil_url: publicAsset('images/four.webp'),
  ...
  },
  {
    ...
    sigil_url: publicAsset('images/five.jpg'),
  ...
  },
  {
    ...
    sigil_url: publicAsset('images/six.jpg'),
...
const HouseCard = ({ house, index }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    tiltFrame.current = requestAnimationFrame(() => {
      ...
      const x = ((pointerRef.current.x - rect.left) / rect.width - 0.5) * 12
      const y = ((pointerRef.current.y - rect.top) / rect.height - 0.5) * 12
      sigilRef.current.style.transform = `rotateY(${x}deg) rotateX(${-y}deg) scale(1.04)`
    })
  }
